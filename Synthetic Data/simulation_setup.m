...
function params = initialize_parameters
    ...
    params.P_D  = 0.85;                                            % probability of detection
    ...
    af = 2;                                                        % measurement noise amplification factor
    params.R = diag([(0.8*af)^2 (0.3*pi*af/180)^2]);               % Covariance of measurements  (range, angle)
end
