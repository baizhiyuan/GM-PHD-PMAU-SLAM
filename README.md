...
The GM-PHD-PMAU-SLAM implementation developed within the [PHD-SLAM-3.0](https://github.com/okaltiok/PHD-SLAM-3.0)'s framework, ensuring usage remains as consistent as possible with the original version to facilitate performance analysis and comparison. We would like to express our gratitude to Ossi Kaltiokallio and collaborators for their open-source contributions. The following are the steps for using the code:
